...
Pod::Spec.new do |spec|
  ...
  spec.author       = { "Bhavik" => "goyal.bhavik28@gmail.com" }
  ...
  # Or just: spec.author    = "Bhavik"
  # spec.authors            = { "Bhavik" => "bhavik.goyal@ril.com" }
  # spec.social_media_url   = "https://twitter.com/Bhavik"
